...
const Home = () => {
  ...
  const technologies = [
    'HTML', 'CSS', 'JavaScript', 'Node.js', 'React', 'Firebase', 'MongoDB', 'Express',
    'HTML', 'CSS', 'JavaScript', 'Node.js', 'React', 'Firebase', 'MongoDB', 'Express'
  ];
        ...
        <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <button
              ...
              className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
          ...
          >
            <div className="relative group">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-full opacity-75 group-hover:opacity-100 blur-lg transition-all duration-500 animate-pulse"></div>
              
              {/* Image container */}
              <div className="relative w-100 h-100 sm:w-80 sm:h-80 rounded-full overflow-hidden border-4 border-white shadow-2xl">
              ...
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-purple-500 rounded-full opacity-20 animate-bounce delay-300"></div>
            </div>
          </div>
          ...
          >
            <div className="space-y-4">
              <div className="inline-block">
                <span className="px-4 py-2 bg-gradient-to-r from-purple-100 to-blue-100 text-purple-700 font-semibold rounded-full text-sm">
